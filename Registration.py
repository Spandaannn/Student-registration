...
def Save(): 
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        file=openpyxl.load_workbook(r'C:\Users\Sharan Shetty\Registration System\Student_data.xlsx')
        sheet=file.active
        ...
        file.save(r'C:\Users\Sharan Shetty\Registration System\Student_data.xlsx')
        try:
...
#top frames
Label(root,text="Email:dcspandandarvekar@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
